...
class ListViewTest(TestCase):
    ...
    def test_displays_only_items_for_that_list(self):
        ...
        Item.objects.create(text='other list itemey1',list=other_list)
        Item.objects.create(text='other list itemey2',list=other_list)
    ...
    def test_duplicate_item_validation_errors_end_up_on_list_page(self):
        ...
        expected_error=escape("此清单中已经有此项目了，不得重复！！")
